          ...
          >
            ...
            {images[0] && (
              <motion.div
                ...
                className="absolute left-0 top-0 w-[52%] h-[220px] overflow-hidden rounded-2xl shadow-xl ring-1 ring-primary/10"
              >
            ...
            {images[1] && (
              <motion.div
                variants={imageVariants}
                className="absolute right-0 top-[30px] w-[48%] h-[200px] z-[5] overflow-hidden rounded-2xl shadow-xl ring-1 ring-primary/10"
              >
            ...
            {images[2] && (
              <motion.div
                variants={imageVariants}
            className="absolute top-[160px] left-[12%] w-[65%] h-[200px] z-10 overflow-hidden rounded-2xl shadow-2xl ring-1 ring-primary/10"
              >
