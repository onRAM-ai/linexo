...
const values = [
  {
    icon: ShieldCheck,
    title: "Reliability",
    desc: "24–48 hour standard turnaround with express and priority processing available. You'll never be left waiting.",
  },
  {
    icon: Layers,
    title: "Hygiene Standards",
    desc: "Commercial-grade processes meeting the highest hygiene benchmarks — proven through government contract compliance.",
  },
  {
    icon: TrendingUp,
    title: "Scalable Capacity",
    desc: "Purpose-built to handle surges — from 50 to 5,000+ pieces daily, with emergency processing on demand.",
  },
  {
    icon: Clock,
    title: "Contractual SLAs",
    desc: "Fixed service schedules and written Service Level Agreements, so you know exactly what you're getting and when.",
  },
];
...
const processSteps = [
  {
    icon: Truck,
    label: "Collect",
    desc: "Scheduled pickup from your premises — or drop off at our facility if that works better for you",
  },
  ...
  { icon: Package, label: "Pack", desc: "Hygienic packaging" },
  {
    icon: ArrowRight,
    label: "Deliver",
    desc: "On-time delivery back to your door — or available for collection from our facility at your convenience",
  },
];
...
const sectors = [
  {
    icon: Hotel,
    title: "Accommodation",
    desc: "Hotels, serviced apartments, and short-stay providers — premium linen hire with reliable turnaround.",
    bg: "bg-primary",
  ...
  },
  {
    ...
    title: "Hospitality",
    desc: "Restaurants, pubs, and event venues — tablecloths, napkins, and service textiles laundered to standard.",
    bg: "bg-primary/85",
    text: "text-primary-foreground",
  },
  {
    ...
    desc: "Mining camps and industrial sites — heavy-duty workwear, PPE, and overalls with surge capacity.",
    bg: "bg-primary/70",
    text: "text-primary-foreground",
  },
];
...
const testimonials = [
  {
    quote:
      "We stopped worrying about linen the day LinExo took over. Fixed schedule, consistent quality, no surprises — exactly what we needed.",
    name: "",
  ...
  {
    quote:
      "Our guests notice the difference. Every sheet pressed, every towel fresh — and we never have to chase a delivery.",
    name: "",
  ...
  {
    quote:
      "Managing PPE and workwear for 200+ crew across remote sites is no small task. LinExo's surge capacity and scheduled delivery changed everything for us.",
    name: "",
  ...
  return (
    <Layout>
      ...
      <HeroSection
        ...
        title={
          <>
            Goldfields' Premier <span className="text-primary">Linen & Laundry</span> Specialists
          </>
        }
      ...
      <section
        id="services"
        className="relative pt-8 md:pt-12 pb-24 md:pb-28 overflow-hidden bg-gradient-to-b from-secondary/30 to-secondary/50"
      >
        ...
        <div className="container relative z-10">
          <div className="mx-auto mb-8 max-w-2xl text-center">
            <h2 className="heading-underline text-4xl font-bold md:text-5xl lg:text-6xl text-foreground">
              Problems We Solve
            </h2>
          </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="text-lg font-bold text-primary-foreground leading-tight mb-2">
                          {pair.solutionTitle}
                        </h3>
                        <motion.p
            ...
            >
              <path
                ...
                style={{
                  ...
                  strokeDashoffset: processInView ? 0 : 1200,
      ...
      <section className="relative py-12 md:py-16 bg-secondary/30 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="mx-auto mb-8 max-w-2xl text-center">
            <h2 className="heading-underline text-4xl font-bold text-foreground md:text-5xl lg:text-6xl">
              Why <span className="text-primary">Lin</span>
            ...
            <div className="grid items-center gap-12 md:grid-cols-5">
              ...
              >
                <div className="mb-4 flex items-center gap-2 text-primary">
                  ...
                  <span className="text-sm font-semibold uppercase tracking-[0.2em] font-sans">
                ...
                <p className="mb-6 text-muted-foreground leading-relaxed">
                  ...
                  <span className="text-accent">Exo</span> is a proudly Western Australian business, purpose-built in
                  the heart of the Goldfields to deliver reliable, high-quality linen and laundry services to the
                  region's accommodation, hospitality, and industrial sectors. With proven government contract
                  experience — including servicing WACHS at Kalgoorlie Regional Health Campus — we bring the compliance,
                  capacity, and consistency that larger operations demand.
                </p>
      ...
      <section id="contact" className="relative overflow-hidden">
        ...
        <div className="absolute -top-1 left-0 right-0 overflow-hidden leading-[0] rotate-180 z-10">
          <svg className="relative block w-full h-12 md:h-20" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path
              d="M0,60 C200,100 400,20 600,60 C800,100 1000,30 1200,50 L1200,120 L0,120 Z"
            ...
            <div className="grid items-start gap-12 lg:grid-cols-5">
              ...
              >
                ...
                <p className="mb-8 text-primary-foreground/80 leading-relaxed">
                  Fixed schedules. 24–48 hour turnaround. Express when you need it. Hygiene compliance handled. SLAs in
                  writing. Tell us what you need and we'll put together a plan that actually works for your operation —
                  no lock-in, no runaround.
                </p>
                <div className="space-y-4 text-primary-foreground/90">
                  <p className="flex items-center gap-3">
                    <Phone className="h-5 w-5 text-primary-foreground/60" /> (08) 9000 0000
                  </p>
                  <p className="flex items-center gap-3">
                    <Mail className="h-5 w-5 text-primary-foreground/60" /> info@linexo.com.au
                  </p>
                  <p className="flex items-center gap-3">
                    <MapPin className="h-5 w-5 text-primary-foreground/60" /> Kalgoorlie-Boulder, WA
                  </p>
                </div>
              </motion.div>
                  ...
                  >
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="space-y-2">
                        <Label htmlFor="cta-name" className="text-primary-foreground/90">
                          Name
                        </Label>
                        <Input
                          id="cta-name"
                          ...
                          required
                          className="border-white/20 bg-white/15 text-primary-foreground placeholder:text-primary-foreground/50 focus-visible:ring-white/30"
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="cta-company" className="text-primary-foreground/90">
                          Company
                        </Label>
                        <Input
                          id="cta-company"
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="space-y-2">
                        <Label htmlFor="cta-email" className="text-primary-foreground/90">
                          Email
                        </Label>
                        <Input
                          id="cta-email"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="cta-phone" className="text-primary-foreground/90">
                          Phone
                        </Label>
                        <Input
                          id="cta-phone"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="cta-message" className="text-primary-foreground/90">
                        Message
                      </Label>
                      <Textarea
                        id="cta-message"
        ...
        <div className="absolute -bottom-1 left-0 right-0 overflow-hidden leading-[0] z-10">
          <svg
            className="animate-wave-drift-slow relative block w-[calc(100%+50px)] -ml-[25px] h-12 md:h-20"
          ...
          <svg
            className="animate-wave-drift absolute -bottom-0 left-0 block w-[calc(100%+50px)] -ml-[25px] h-12 md:h-20"
            viewBox="0 0 1200 120"
            preserveAspectRatio="none"
          >
            <path
